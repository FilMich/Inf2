...
/**
 * Vytvori druhu miestnost
 */
public class DruhaMiestnost implements IMiestnost {
    ...
    public DruhaMiestnost(ManagerOfSources managerOfSources, SpriteBatch batch) {
    ...
    public void vytvorMiestnost() {
        for (int xPodlaha = 5; xPodlaha < 24; xPodlaha++) {
            for (int yPodlaha = 2; yPodlaha < 14; yPodlaha++) {
                this.objekty.add(new Podlaha(this.managerOfSources, xPodlaha, yPodlaha, TypPolicka.GREY));
            }
        }
    ...
    /**
     * metoda na vykreslenie miestnosti
     */
    @Override
    ...
    /**
     * metoda na vytvorenie interaktivnych objektov
     */
    @Override
    ...
    /**
     * metoda na nakreslenie interaktivnych objektov
     */
    @Override
