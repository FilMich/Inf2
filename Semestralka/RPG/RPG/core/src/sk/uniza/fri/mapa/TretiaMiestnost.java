...
/**
 * vytvorenie tretej miestnosti
 */
public class TretiaMiestnost implements IMiestnost {
    ...
    public TretiaMiestnost(ManagerOfSources managerOfSources, SpriteBatch batch) {
    ...
    public void vytvorMiestnost() {
        for (int xPodlaha = 5; xPodlaha < 24; xPodlaha++) {
            for (int yPodlaha = 2; yPodlaha < 14; yPodlaha++) {
                this.objekty.add(new Podlaha(this.managerOfSources, xPodlaha, yPodlaha, TypPolicka.LIGHT_GREY));
            }
        }
    ...
    /**
     * metoda na vytvorenie interaktivneho objeku
     */
    @Override
